...
class DataFilter extends Component{
  ...
  countrySelected=(arr)=>{
      // if(arr!==null){
      //   this.props.handleCountryOption(arr.value);
      // }
      ...
      if(arr===null){
        ...
        this.props.handleCountryOption("Select a Country...");
        return
      }else{
...
//------------------{{ STATE FILTERS}}-----------------------------------------
  stateSelected=(arr)=>{
    // if(arr!==null){
    //   this.props.handleStateOption(arr.value);
    // }
    ...
    if(arr===null){
        ...
        this.props.handleStateOption("Select a State...");
      return
    }else{
...
citySelected=(arr)=>{
  // if(arr!==null){
  //   this.props.handleCityOption(arr.value);
  // }
  ...
  if(arr===null){
    ...
    this.props.handleCityOption("Select a City...");
    return
  }else{
...
render() {
  console.log("In in render datafilter : ",this.state.value);
  const {filter} =  this.state;
    return (<>
      <Filterpopup 
          ...
          show_names={this.props.show_names}
